...
<template>
	<div class="flex h-full w-full flex-col justify-center text-center">
		<div :style="{ ...css }" class="h-62.5 w-full bg-contain bg-center bg-no-repeat sm:h-87.5 md:h-100">
			<span class="text-center text-6xl sm:text-7xl md:text-8xl">404</span>
		</div>

		<div class="-mt-12.5 w-full">
			<span class="mb-4 text-2xl font-bold sm:text-3xl">哎呀，页面跑丢了！</span>
